...
export default function DisposePage() {
  ...
  const devices = {
    Smartphone: {
      ...
      creditMultiplier: 40, // 💰 10 credits per unit price
    },
    Laptop: {
      brands: {
      ...
      creditMultiplier: 60, // 💰 15 credits per unit price
    },
    Accessories: {
      brands: {
      ...
      creditMultiplier: 30, // 💰 5 credits per unit price
    },
    Television: {
      brands: {
      ...
      creditMultiplier: 50, // 💰 12 credits per unit price
    },
    Refrigerator: {
      brands: {
      ...
      creditMultiplier: 50, // 💰 18 credits per unit price
    },
    Other: {
      brands: {},
